package com.magician.HomeServo.service;
...
import com.magician.HomeServo.dao.CustomerDao;
import com.magician.HomeServo.dto.Customer;
import com.magician.HomeServo.exception.EmailNotFoundForCustomer;
import com.magician.HomeServo.exception.NoSuchElementFoundByCustomerIdException;
import com.magician.HomeServo.exception.PasswordIncorrectException;
...
//	}	
	...
	public ResponseEntity<ResponseStruture<com.magician.HomeServo.duplicate.Customer>> findById(int id){
		Customer db = dao.findById(id);
		com.magician.HomeServo.duplicate.Customer customer = new com.magician.HomeServo.duplicate.Customer();
		ResponseStruture<com.magician.HomeServo.duplicate.Customer> struture = new ResponseStruture<com.magician.HomeServo.duplicate.Customer>();
		if(db != null) {
...
//			customer.setPhno(db.getPhone());
			...
			customer = (com.magician.HomeServo.duplicate.Customer)this.mapper.map(db, com.magician.HomeServo.duplicate.Customer.class);
			
			struture.setData(customer);
			struture.setMessage("The Customer Data found...");
			struture.setStatus(HttpStatus.FOUND.value());
			
			return new ResponseEntity<ResponseStruture<com.magician.HomeServo.duplicate.Customer>>(struture,HttpStatus.FOUND);
		}
		else {
